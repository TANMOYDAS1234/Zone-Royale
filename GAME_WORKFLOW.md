...
Ready-to-paste AI prompts live in a separate file: **DESIGN_PROMPTS.md**.
...
Control Placement). The game is **landscape only** — there is no portrait mode.
...
The AI prompts (Stitch.ai UI kit, in-game art) live in their own file so this
spec stays a spec: **[DESIGN_PROMPTS.md](DESIGN_PROMPTS.md)**.
