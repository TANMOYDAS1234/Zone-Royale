  ...
  Future<void> _confirmSkip(BuildContext context) async {
    final sure = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(trUp('SKIP TUTORIAL'), style: ZR.display(20)),
        content: Text(
            tr('You can watch it again any time from the profile screen.'),
            style: ZR.body(12, color: Colors.white70)),
        actions: [
          TextButton(
              onPressed: () => Navigator.of(ctx).pop(false),
              child: Text(trUp('CANCEL'),
